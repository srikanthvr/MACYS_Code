...
class AcromineClient: NSObject {
    ...
    class func getDataFromAcromine(parameter: String, completion: @escaping (_ response: [MeaningObject], _ error: Error?)-> ()){
        ...
        manager.get("\(baseUrl)?sf=\(parameter)", parameters: nil, progress: nil, success: { seesionTask, response in
            ...
            if jsonArray.count > 0{
                ...
                meaningObj = MeaningObject.meaningsWithArray(array: ifsArray)
